...
Citizen.CreateThread(function()
	...
	TriggerEvent('chat:addSuggestion', '/vidros', 'Abrir e fechar os vidros do veículo.')
	...
	TriggerEvent('chat:addSuggestion', '/som ligar', 'Para ligar o rádio do veículo.')
	TriggerEvent('chat:addSuggestion', '/som musica', 'Para colocar o link de uma música.')
	TriggerEvent('chat:addSuggestion', '/som desligar', 'Para desligar o rádio do veículo.')
	TriggerEvent('chat:addSuggestion', '/som volume', 'Para alterar o volume da música.')
	...
	TriggerEvent('chat:addSuggestion', '/limparinv', 'Limpar inventário de um jogador.', {{ name="PASSAPORTE"}})
    ...
    TriggerEvent('chat:addSuggestion', '/prefem', 'Para pegar um jogador como refém.')
	TriggerEvent('chat:addSuggestion', '/anuncio', 'Fazer um anuncio para os jogadores.')
	TriggerEvent('chat:addSuggestion', '/entrar', 'Caso a casa esteja disponível aparece o valor para comprar.')
	...
	TriggerEvent('chat:addSuggestion', '/bau', 'Para acessar o baú da casa.')
