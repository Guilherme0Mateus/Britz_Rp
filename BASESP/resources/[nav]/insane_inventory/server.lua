...
vRPN = {}
Tunnel.bindInterface("insane_inventory",vRPN)
Proxy.addInterface("insane_inventory",vRPN)
		...
		if type == "usar" then
            ...
            elseif itemName == "paracetamil" then
                if vRP.tryGetInventoryItem(user_id,"paracetamil",1) then
                	...
                	TriggerClientEvent('Creative:Update',source,'updateMochila')
                	TriggerClientEvent('cancelando',source,true)
                    TriggerClientEvent("progress",source,20500,"paracetamil")
            ...
            elseif itemName == "voltarom" then
                if vRP.tryGetInventoryItem(user_id,"voltarom",1) then
                	...
                	TriggerClientEvent('Creative:Update',source,'updateMochila')	
					TriggerClientEvent('cancelando',source,true)
                    TriggerClientEvent("progress",source,20500,"voltarom")
                    SetTimeout(20500,function()
                        TriggerClientEvent('cancelando',source,false)
                        TriggerClientEvent("resetBleeding",source)
                        vRPclient._DeletarObjeto(source)
			...
			elseif itemName == "maconha-alta" then
				if vRP.tryGetInventoryItem(user_id,"maconha-alta",1) then
					actived[user_id] = true
					TriggerClientEvent('Creative:Update',source,'updateMochila')
			...
			elseif itemName == "coca-alta" then
				if vRP.tryGetInventoryItem(user_id,"coca-alta",1) then
					actived[user_id] = true
					TriggerClientEvent('Creative:Update',source,'updateMochila')
					vRPclient._playAnim(source,true,{{"mp_player_int_uppersmoke","mp_player_int_smoke"}},true)
					TriggerClientEvent('cancelando',source,true)
			...
			elseif itemName == "meta-alta" then
				if vRP.tryGetInventoryItem(user_id,"meta-alta",1) then
					actived[user_id] = true
					TriggerClientEvent('Creative:Update',source,'updateMochila')
					vRPclient._playAnim(source,true,{{"mp_player_int_uppersmoke","mp_player_int_smoke"}},true)
					TriggerClientEvent("progress",source,10000,"fumando")
			...
			elseif itemName == "ovo" then
				...
				if vRP.getInventoryItemAmount(user_id,"ovo") >= 1 and vRP.tryGetInventoryItem(user_id,"ovo",1) and vehicle then
					actived[user_id] = true
