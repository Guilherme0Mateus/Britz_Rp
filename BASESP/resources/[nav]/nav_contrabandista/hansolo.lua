...
RegisterNUICallback("ButtonClick",function(data,cb)
	...
	elseif data == "comprar-rebite" then
		TriggerServerEvent("contrabandista-comprar","rebite")

	elseif data == "comprar-colete" then
		TriggerServerEvent("contrabandista-comprar","colete")

	elseif data == "comprar-pendrive" then
...
-----------------------------------------------------------------------------------------------------------------------------------------
local lojas = {
	{ ['x'] = -571.61, ['y'] = 288.95, ['z'] = 79.18 },
	{ ['x'] = -146.2, ['y'] = 2140.1, ['z'] = 171.53 }
}
-----------------------------------------------------------------------------------------------------------------------------------------
--[ MENU ]-------------------------------------------------------------------------------------------------------------------------------
-----------------------------------------------------------------------------------------------------------------------------------------
