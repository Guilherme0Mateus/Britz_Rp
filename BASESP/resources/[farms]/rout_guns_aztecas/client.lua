...
emP = Tunnel.getInterface("rout_guns_aztecas")
-----------------------------------------------------------------------------------------------------------------------------------------
-- VARIAVEIS
-----------------------------------------------------------------------------------------------------------------------------------------
local blips = false
local servico = false
local selecionado = 0
local CoordenadaX = -642.93
local CoordenadaY = -1227.99
local CoordenadaZ = 11.55
local processo = false
local segundos = 0
-- ['x'] = -642.93, ['y'] = -1227.99, ['z'] = 11.55
-----------------------------------------------------------------------------------------------------------------------------------------
-- RESIDENCIAS
-----------------------------------------------------------------------------------------------------------------------------------------
local locs = {
	...
	while true do
		...
		if servico then
			...
			if distance <= 3 then
				...
				if distance <= 1.2 then
					daleminhapikatxt("PRESSIONE  ~r~E~w~  PARA COLETAR AS PEÇAS DE ARMAS",4,0.5,0.93,0.50,255,255,255,180)
