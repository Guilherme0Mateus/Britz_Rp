...
Citizen.CreateThread(function()
	while true do
		Citizen.Wait(1)
		if GetDistanceBetweenCoords(GetEntityCoords(PlayerPedId()), -126.49,2191.71,159.46,true) <= 1 then
			DrawText3Ds(-126.49,2191.71,159.46+0.5,"PRESSIONE ~r~E~w~ PARA COMEÇAR MISSÃO")
		...
		if emservico then
			...
			if statuses then
				...
				drawTxt(ui.right_x+0.050,ui.bottom_y-0.058,1.0,1.0,0.45,"ENTREGUE ~g~"..quantidade.."~w~ COCAINAS",255,255,255,255)
			else
