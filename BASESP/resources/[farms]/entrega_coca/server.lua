...
emp = {}
Tunnel.bindInterface("entrega_coca",emp)
...
AddEventHandler('entrega_coca:itensReceber', function(quantidade)
	local src = source
    ...
    if user_id then
        ...
        if new_weight <= vRP.getInventoryMaxWeight(user_id) then
            if vRP.tryGetInventoryItem(user_id,"coca-alta",quantidade,true) then
