...
Perm = Tunnel.getInterface("insane_shop_buy_two")
-----------------------------------------------------------------------------------------------------------------------------------------
--[ Menu ]------------------------------------------------------------------------------------------------------------------------------
-----------------------------------------------------------------------------------------------------------------------------------------
...
RegisterNUICallback("ButtonClick",function(data,cb)
    if data == "comprar-polvora" then
		TriggerServerEvent("rolacomprafsa","polvora")
	elseif data == "comprar-capsula" then
		TriggerServerEvent("rolacomprafsa","capsulas")
...
-----------------------------------------------------------------------------------------------------------------------------------------
local lojas = {
	{ ['x'] = -1715.93, ['y'] = 3021.98, ['z'] = 32.82 }, -- METRALHAS
}
-----------------------------------------------------------------------------------------------------------------------------------------
--[ MENU ]-------------------------------------------------------------------------------------------------------------------------------
-----------------------------------------------------------------------------------------------------------------------------------------
