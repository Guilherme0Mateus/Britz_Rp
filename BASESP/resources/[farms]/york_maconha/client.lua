...
local locais = { 
	...
	{ ['id'] = 1, ['x'] = 99.78, ['y'] = 6344.38, ['z'] = 31.38, ['text'] = "colher a Sativa", ['perm'] = "pccc.permissao" }, 
	{ ['id'] = 2, ['x'] = 101.95, ['y'] = 6353.35, ['z'] = 31.38, ['text'] = "colher a Índica", ['perm'] = "pccc.permissao" }, 
	{ ['id'] = 3, ['x'] =  116.47, ['y'] = 6362.53, ['z'] = 32.79, ['text'] = "preparar a Maconha", ['perm'] = "pccc.permissao" },
}  
...
function separando()
	Citizen.CreateThread(function()
		while true do
			...
			TriggerEvent('Notify', 'sucesso', 'Você Empacotou as Maconhas!.')
