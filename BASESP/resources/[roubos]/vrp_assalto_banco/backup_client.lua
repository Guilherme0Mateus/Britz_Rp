                                ...
                                if IsControlPressed(0, 38) then
									...
									if solda then
										if cops then
											...
											local welded = true
                                            for i = 1, 600 do
                                                drarola("APERTE ~r~M~w~ PARA CANCELAR O ROUBO EM ANDAMENTO",4,0.5,0.91,0.36,255,255,255,70, d.Time)
                                                drarola("RESTAM ~g~".. math.floor(i/6) .."% ~w~PARA EXPLODIR",4,0.5,0.93,0.50,255,255,255,180, d.Time)
...
function drarola(text,font,centre,x,y,scale,r,g,b,a)
	SetTextFont(font)
...
function drawSub(text,font,centre,x,y,scale,r,g,b,a, time)
    ...
    while timesdone <= time/10 do
        drarola(text, font, centre, x, y, scale, r, g, b, a)
		Wait(0)
