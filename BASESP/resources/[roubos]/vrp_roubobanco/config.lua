...
Config.BankRobbery = {
    [1] = {
        ...
        Doors = { 
            ...
            {Coords = vector3(253.25, 221.16, 101.68), Object = "hei_v_ilev_bk_safegate_pris", Heading = 160.0, WeldPosition = {C = vector3(253.53,221.00,100.68), H = 158.38}, Time = 2, Frozen = true}, 
