webpackJsonp([0], [, , , , , , function(t, e, n) {
  ...
  h = {
   ...
   notesAddMessage: function(t, e) {
    ...
    void 0 !== n.channels.find(function(t) {
     return t.channel === a
    }) && (null !== c && (c.pause(), c = null), c = new Audio("/html/static/sound/tchatNotification.ogg"), c.volume = o.volume, c.play()), s("NOTES_ADD_MESSAGES", {
     message: i
    })
   },
  ...
  methods: {
   onSelect: function(t) {
    ...
    !0 !== this.ignoreControls && (this.ignoreControls = !0, l.a.CreateModal({
     ...
     e.ignoreControls = !1, "Cancelar" !== t.title && (e.$phoneAPI.callEvent(t.eventName, t.type), e.$router.push({
      name: "home"
     }))
    }))
   }
 ...
 e.default = {
  ...
  methods: o()({}, n.i(i.a)(["sendpara"]), {
   ...
   onUp: function() {
    this.currentSelect - 1 >= 0 && (this.currentSelect = this.currentSelect - 1), this.$refs["form" + this.currentSelect].focus(), console.log(this.currentSelect)
   },
   onDown: function() {
    this.currentSelect + 1 <= 3 && (this.currentSelect = this.currentSelect + 1), this.$refs["form" + this.currentSelect].focus(), console.log(this.currentSelect)
   },
   onEnter: function() {
    var t = this;
 ...
 t.exports = {
  render: function() {
   ...
   return n("div", {
    ...
    class: {
     hasInfoBare: t.daleminhapikainfoBare
    },
    style: t.style
   }, [t.daleminhapikainfoBare ? n("InfoBare") : t._e(), t._v(" "), n("div", {
 ...
 t.exports = {
  render: function() {
   ...
   return n("div", {
    ...
    attrs: {
     title: t.title,
     daleminhapikainfoBare: t.daleminhapikainfoBare
    },
    on: {
     back: t.back
    }
