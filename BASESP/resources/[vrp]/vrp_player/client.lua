...
Citizen.CreateThread(function()
    while true do
        if not density then
            ...
            SetSomeVehicleDensityMultiplierThisFrame(pedDensity)
...
function setNotHurt()
    ...
    DisableControlAction(0,21, false) -- SHIFT
end


RegisterNetEvent('termali')
AddEventHandler('termali', function()
	if GetPedPropIndex(PlayerPedId(),0) == 118 then
		SetNightvision(true)
		SetSeethrough(true)
...
local css = [[
	...
	.label_carteira p {
		background: linear-gradient(270deg, rgba(74, 255, 213,1), rgba(74, 255, 213,0.3));
	...
	.info_carteira .info_section:first-child{
		border-top-left-radius: 8px;
		border-top-right-radius: 8px;
	}
	.info_carteira .info_section:last-child{
		border-bottom-left-radius: 8px;
		border-bottom-right-radius: 8px;
		box-shadow: 0 2px 1px #c3c3c3;
		border: 0;
	}
	.info_carteira .info_section .icon {
		width: 30px;
		height: 30px;
	...
	.info_carteira .info_section .info {
		float: right;
		color: #111;
		padding-right: 5px;
	}
...
Citizen.CreateThread(function()
	while true do
		Citizen.Wait(1)
		if IsControlJustPressed(0,344) and GetEntityHealth(PlayerPedId()) > 105 then
			local ped = PlayerPedId()
			local saude = GetEntityHealth(ped)
			local saude = saude * 0.25
			local hunger, thirst = ykP.fomeSede()
			local trabalho,vip,discord = ykP.checkJobs()

			if identity then
				vRP._removeDiv("registro")
				identity = false
			else
				local carteira,banco,nome,sobrenome,user_id,identidade,idade,telefone,multas,paypal = ykP.Identidade()
				if parseInt(multas) > 0 then
					vRP._setDiv("registro",css,"<div class=\"label_carteira\"><p>South BR</p></div><div class=\"info_carteira\"><div class=\"info_section\"><div class=\"icon\" style=\"background-image: url(\'http://officialyu.me/icones/fingerprint.svg\');\"></div>Dados: <span class=\"info\">"..nome.." "..sobrenome..", "..idade.."</span></div><div class=\"info_section\"><div class=\"icon\" style=\"background-image: url(\'http://officialyu.me/icones/team.svg\');\"></div>Profissão: <span class=\"info\">"..trabalho.."</span></div><div class=\"info_section\"><div class=\"icon\" style=\"background-image: url(\'http://officialyu.me/icones/checklist.svg\');\"></div>Multas: <span class=\"info\">$"..multas.."</span></div><div class=\"info_section\"><div class=\"icon\" style=\"background-image: url(\'http://officialyu.me/icones/passport.svg\');\"></div>Passaporte: <span class=\"info\">"..user_id.."</span></div><div class=\"info_section\"><div class=\"icon\" style=\"background-image: url(\'http://officialyu.me/icones/smartphone.svg\');\"></div>Telefone: <span class=\"info\">"..telefone.."</span></div><div class=\"info_section\"><div class=\"icon\" style=\"background-image: url(\'http://officialyu.me/icones/dollar-symbol.svg\');\"></div>Carteira: <span class=\"info\">$"..carteira.."</span></div><div class=\"info_section\"><div class=\"icon\" style=\"background-image: url(\'http://officialyu.me/icones/money.svg\');\"></div>Banco: <span class=\"info\">$"..banco.."</span></div><div class=\"info_section\"><div class=\"icon\" style=\"background-image: url(\'http:/officialyu.me/icones/vip.svg\');\"></div>VIP: <span class=\"info\">"..vip.."</span></div><div class=\"info_section\"><div class=\"icon\" style=\"background-image: url(\'http://officialyu.me/icones/discord.svg\');\"></div>Boosting: <span class=\"info\">"..discord.."</span></div><div class=\"info_section\"><div class=\"icon\" style=\"background-image: url(\'http://officialyu.me/icones/burger.svg\');\"></div>Fome: <span class=\"info\">"..hunger.."%</span></div><div class=\"info_section\"><div class=\"icon\" style=\"background-image: url(\'http://officialyu.me/icones/water.svg\');\"></div>Sede: <span class=\"info\">"..thirst.."%</span></div></div>")
				else
					vRP._setDiv("registro",css,"<div class=\"label_carteira\"><p>South BR</p></div><div class=\"info_carteira\"><div class=\"info_section\"><div class=\"icon\" style=\"background-image: url(\'http://officialyu.me/icones/fingerprint.svg\');\"></div>Dados: <span class=\"info\">"..nome.." "..sobrenome..", "..idade.."</span></div><div class=\"info_section\"><div class=\"icon\" style=\"background-image: url(\'http://officialyu.me/icones/team.svg\');\"></div>Profissão: <span class=\"info\">"..trabalho.."</span></div><div class=\"info_section\"><div class=\"icon\" style=\"background-image: url(\'http://officialyu.me/icones/passport.svg\');\"></div>Passaporte: <span class=\"info\">"..user_id.."</span></div><div class=\"info_section\"><div class=\"icon\" style=\"background-image: url(\'http://officialyu.me/icones/smartphone.svg\');\"></div>Telefone: <span class=\"info\">"..telefone.."</span></div><div class=\"info_section\"><div class=\"icon\" style=\"background-image: url(\'http://officialyu.me/icones/dollar-symbol.svg\');\"></div>Carteira: <span class=\"info\">$"..carteira.."</span></div><div class=\"info_section\"><div class=\"icon\" style=\"background-image: url(\'http://officialyu.me/icones/money.svg\');\"></div>Banco: <span class=\"info\">$"..banco.."</span></div><div class=\"info_section\"><div class=\"icon\" style=\"background-image: url(\'http:/officialyu.me/icones/diamond.svg\');\"></div>VIP: <span class=\"info\">"..vip.."</span></div><div class=\"info_section\"><div class=\"icon\" style=\"background-image: url(\'http://officialyu.me/icones/discord.svg\');\"></div>Boosting: <span class=\"info\">"..discord.."</span></div><div class=\"info_section\"><div class=\"icon\" style=\"background-image: url(\'http://officialyu.me/icones/burger.svg\');\"></div>Fome: <span class=\"info\">"..hunger.."%</span></div><div class=\"info_section\"><div class=\"icon\" style=\"background-image: url(\'http://officialyu.me/icones/water.svg\');\"></div>Sede: <span class=\"info\">"..thirst.."%</span></div></div>")
				end
				identity = true
			end
		end
