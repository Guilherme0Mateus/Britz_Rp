...
local lojaderoupa = {
    ...
    { name = "Loja de Roupas", id = 73, color = 13, x = 199.80, y = -872.65, z = 30.71, provador = {x = 199.89, y = -872.81, z = 30.71, heading = 0.0}},
    ...
    while true do
        ...
        for k, v in pairs(lojaderoupa) do
            ...
            if GetDistanceBetweenCoords(playerCoords.x, playerCoords.y, playerCoords.z, lojaderoupa[k].x, lojaderoupa[k].y, lojaderoupa[k].z, true ) <= 1.8 and not in_loja then
                kswait = 4
                DrawMarker(21,lojaderoupa[k].x, lojaderoupa[k].y, lojaderoupa[k].z-0.2,0,0,0,0.0,0,0,0.4,0.4,0.4,99,47,121,100,1,0,0,1)
