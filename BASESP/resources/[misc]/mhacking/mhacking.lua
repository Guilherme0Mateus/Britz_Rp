	...
	while true do
		...
		if showHelp then
			if helpTimer > GetGameTimer() then
				daleminhapikatxt("NAVEGUE COM ~y~W, A, S, D~s~ E CONFIRME COM ~y~ESPAÇO~s~ PARA O BLOCO DE CÓDIGO DA ESQUERDA",4,0.5,0.90,0.50,255,255,255,180)
			...
			elseif helpTimer > GetGameTimer()-helpCycle then
				daleminhapikatxt("NAVEGUE COM AS ~y~SETAS~s~ E CONFIRME COM ~y~ENTER~s~ PARA O BLOCO DE CÓDIGO DA DIREITA",4,0.5,0.90,0.50,255,255,255,180)
			else
