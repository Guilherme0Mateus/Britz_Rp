RegisterNetEvent("insane-character:normalSpawn")
RegisterNetEvent("insane-character:characterCreate")
...
AddEventHandler("insane-character:characterCreate",function()
	doStatus = 1
...
AddEventHandler("insane-character:normalSpawn",function(firstspawn)
	if firstspawn then
...
function TriggerCreateCharacter()
	...
	TeleportPlayerNoOffset(PlayerPedId(),402.55,-996.37,-99.01,true,true,true) 
...
function refreshDefaultCharacter()
	...
	if GetEntityModel(PlayerPedId()) == GetHashKey("mp_m_freemode_01") then
		...
		SetPedComponentVariation(PlayerPedId(),11,280,12,2)
		SetPedComponentVariation(PlayerPedId(),9,-1,0,2)
		SetPedComponentVariation(PlayerPedId(),10,-1,0,2)
		SetPedPropIndex(PlayerPedId(),2,-1,0,2)
		SetPedPropIndex(PlayerPedId(),6,-1,0,2)
...
RegisterNUICallback('cDoneSave',function(data,cb)
	...
	if GetEntityModel(PlayerPedId()) == GetHashKey("mp_m_freemode_01") then
		SetPedComponentVariation(PlayerPedId(),1,-1,0,2)
		SetPedComponentVariation(PlayerPedId(),2,4,0,2)
		SetPedComponentVariation(PlayerPedId(),5,-1,0,2)
		SetPedComponentVariation(PlayerPedId(),7,-1,0,2)
		SetPedComponentVariation(PlayerPedId(),3,0,0,2)
		SetPedComponentVariation(PlayerPedId(),4,1,2,2)
		SetPedComponentVariation(PlayerPedId(),8,15,0,2)
		SetPedComponentVariation(PlayerPedId(),6,16,10,2)
		SetPedComponentVariation(PlayerPedId(),11,271,0,2)
		SetPedComponentVariation(PlayerPedId(),9,-1,0,2)
		SetPedComponentVariation(PlayerPedId(),10,-1,0,2)
		SetPedPropIndex(PlayerPedId(),0,62,3,2)
		...
		SetPedComponentVariation(PlayerPedId(),5,-1,0,2)
		SetPedComponentVariation(PlayerPedId(),7,-1,0,2)
		SetPedComponentVariation(PlayerPedId(),4,0,5,2)
		SetPedComponentVariation(PlayerPedId(),8,3,0,2)
		SetPedComponentVariation(PlayerPedId(),6,16,9,2)
		SetPedComponentVariation(PlayerPedId(),11,280,12,2)
		SetPedComponentVariation(PlayerPedId(),9,-1,0,2)
		SetPedComponentVariation(PlayerPedId(),10,-1,0,2)
		SetPedPropIndex(PlayerPedId(),0,62,0,2)
		SetPedPropIndex(PlayerPedId(),1,8,0,2)
		SetPedPropIndex(PlayerPedId(),2,-1,0,2)
		SetPedPropIndex(PlayerPedId(),6,-1,0,2)
		SetPedPropIndex(PlayerPedId(),7,-1,0,2)
	end

	TeleportPlayerNoOffset(PlayerPedId(),-514.55,-255.59,35.62,true,true,true)
	...
	TriggerServerEvent("insane-character:finishedCharacter",characterNome,characterSobrenome,characterAge,currentCharacterMode)
end)
