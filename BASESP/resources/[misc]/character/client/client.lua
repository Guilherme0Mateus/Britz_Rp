...
RegisterNUICallback('cDoneSave',function(data,cb)
	...
	SetEntityCoordsNoOffset(PlayerPedId(),-617.28,-2208.79,6.01,true,true,true)
	SetEntityHeading(PlayerPedId(),f(205.57))
	...
	TriggerServerEvent("character:finishedCharacter",characterNome,characterSobrenome,characterAge,currentCharacterMode)
end)
