...
Citizen.CreateThread(function()
	while true do
		...
		if GetDistanceBetweenCoords(GetEntityCoords(ped), -4.77,-654.20,33.45,true) <= 30 then
		    DrawText3D(-4.77, -654.20, 33.45+0.47, "~w~Prosegur", 1.0, 4)
		    DrawText3D(-4.77, -654.20, 33.45+0.35, "~b~Entregas de Sacos de Dinheiro", 0.8, 1)
		    DrawMarker(39, -4.77, -654.20, 33.45-0.1, 0, 0, 0, 0, 0, 0, 1.0, 1.0, 1.0, 65, 105, 255, 50, 0, true, false, false)
		    if GetDistanceBetweenCoords(GetEntityCoords(ped), -4.77,-654.20,33.45,true) <= 1 then
		...
		if emservico and parte == 0 then
			if GetDistanceBetweenCoords(GetEntityCoords(ped), -10.01,-657.23,33.45,true) <= 20 then
		        DrawMarker(21,-10.01,-657.23,33.45-0.6,0,0,0,0.0,0,0,0.5,0.5,0.4,65,105,255,50,0,0,0,1)
		        if GetDistanceBetweenCoords(GetEntityCoords(ped), -10.01,-657.23,33.45,true) <= 1 then
                    if IsControlJustPressed(0,38) then	
                    	Fade(1200)
		...
		if emservico and parte == 1 then
			...
			local distance = GetDistanceBetweenCoords(GetEntityCoords(ped),-7.03,-654.11,33.45,true)
			...
			if distance <= 50 and not pegando and portaaberta then
				DrawMarker(21,-7.03,-654.11,33.45-0.6,0,0,0,0.0,0,0,0.5,0.5,0.4,65,105,255,50,0,0,0,1)
			...
			if distance2 <= 1.5 and pegando and not IsPedInAnyVehicle(ped) then
			    if model == -1745203402 and GetVehicleNumberPlateText(veh) == vRP.getRegistrationNumber() then
			...
			for i = 1,20 do
			    ...
			    if distancecaixa <= 50 and entregando and retirando then
				    if distancecaixa < 1.3 and not IsPedInAnyVehicle(ped) then
					    DrawText3Ds(entregalocal[i].x,entregalocal[i].y,entregalocal[i].z+0.35,"~b~[S] ~w~Entregar Saco de Dinheiro")
					    TriggerEvent('cancelando',false)
	            ...
	            elseif distancecaixa <= 50 and not entregando and not retirando then
				    DrawMarker(21,entregalocal[i].x,entregalocal[i].y,entregalocal[i].z-0.6,0,0,0,0.0,0,0,0.5,0.5,0.4,65,105,255,50,0,0,0,1)
...
function CaixaStock(veh,model)
	if quantidade <= 15 then
		...
		if quantidade == 1 and model == -1745203402 then
			propcaixa = nil
		...
		elseif quantidade == 2 and model == -1745203402 then
			propcaixa2 = nil
		...
		elseif quantidade == 3 and model == -1745203402 then
			propcaixa3 = nil
		...
		elseif quantidade == 4 and model == -1745203402 then
			propcaixa4 = nil
		...
		elseif quantidade == 5 and model == -1745203402 then
			propcaixa5 = nil
		...
		elseif quantidade == 6 and model == -1745203402 then
			propcaixa6 = nil
		...
		elseif quantidade == 7 and model == -1745203402 then
			propcaixa7 = nil
		...
		elseif quantidade == 8 and model == -1745203402 then
			propcaixa8 = nil
		...
		elseif quantidade == 9 and model == -1745203402 then
			propcaixa9 = nil
		...
		elseif quantidade == 10 and model == -1745203402 then
			propcaixa10 = nil
		...
		elseif quantidade == 11 and model == -1745203402 then
			propcaixa11 = nil
		...
		elseif quantidade == 12 and model == -1745203402 then
			propcaixa12 = nil
		...
		elseif quantidade == 13 and model == -1745203402 then
			propcaixa13 = nil
		...
		elseif quantidade == 14 and model == -1745203402 then
			propcaixa14 = nil
		...
		elseif quantidade == 15 and model == -1745203402 then
			propcaixa15 = nil
	...
	if not nveh then
	 while not HasModelLoaded(mhash) do
	  RequestModel(mhash)
		...
		nveh = CreateVehicle(mhash,-6.04,-669.45,31.94+0.5,184.20,true,false)
