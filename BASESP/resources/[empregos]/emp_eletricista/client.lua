...
local obj = GetClosestObjectOfType(GetEntityCoords(ped).x, GetEntityCoords(ped).y, GetEntityCoords(ped).z, 3.0, GetHashKey(objects[1]), false, true ,true)
		...
		if distance <= 30 then
			DrawMarker(21,-825.55084228516,-731.86492919922,27.074931640625,0,0,0,0.0,0,0,0.5,0.5,0.4,255,0,0,50,0,0,0,1)
...
drarola("AGUARDE ~b~"..segundos.."~w~ SEGUNDOS ATÉ FINALIZAR O REPARO",4,0.5,19,0.50,255,255,255,180)
else
