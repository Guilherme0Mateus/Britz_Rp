...
emP = Tunnel.getInterface("lixeiro_coletar")
-----------------------------------------------------------------------------------------------------------------------------------------
-- VARIAVEIS
-----------------------------------------------------------------------------------------------------------------------------------------
local blips = false
		...
		if not servico then
			...
			if distance <= 3 then
				...
				if distance <= 1.2 then
					daleminhapikatxt("PRESSIONE  ~r~E~w~  PARA INICIAR A COLETA",4,0.5,0.93,0.50,255,255,255,180)
		...
		if servico then
			...
			if distance <= 30.0 then
				...
				if distance <= 2.5 then
					daleminhapikatxt("PRESSIONE  ~r~E~w~  PARA COLETAR OS SACOS DE LIXO",4,0.5,0.93,0.50,255,255,255,180)
					if IsControlJustPressed(0,38) then
