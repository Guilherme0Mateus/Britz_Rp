...
Radio.Labels = {        
    { "FRZL_RADIO_HELP", "~s~" .. (radioConfig.Controls.Secondary.Enabled and "~" .. radioConfig.Controls.Secondary.Name .. "~ + ~" .. radioConfig.Controls.Activator.Name .. "~" or "~" .. radioConfig.Controls.Activator.Name .. "~") .. " para fechar o menu.~n~~" .. radioConfig.Controls.Toggle.Name .. "~ para ~g~ligar~s~.~n~~" .. radioConfig.Controls.Decrease.Name .. "~ ou ~" .. radioConfig.Controls.Increase.Name .. "~ para trocar a frequencia~n~~" .. radioConfig.Controls.Input.Name .. "~ para escolher a frequencia~n~~" .. radioConfig.Controls.ToggleClicks.Name .. "~ para ~a~ beeps do radio~n~Frequencia: ~1~ MHz" },
    { "FRZL_RADIO_HELP2", "~s~" .. (radioConfig.Controls.Secondary.Enabled and "~" .. radioConfig.Controls.Secondary.Name .. "~ + ~" .. radioConfig.Controls.Activator.Name .. "~" or "~" .. radioConfig.Controls.Activator.Name .. "~") .. " para fechar o menu~n~~" .. radioConfig.Controls.Toggle.Name .. "~ para ~r~desligar~s~.~n~~" .. radioConfig.Controls.Broadcast.Name .. "~ para falar.~n~Frequencia: ~1~ MHz" },
    ...
    while true do
        ...
        if Radio.Open then
            ...
            if not Radio.On then
                AddTextComponentSubstringPlayerName(Radio.Clicks and "~r~desativar~w~" or "~g~ativar~w~")
            end
