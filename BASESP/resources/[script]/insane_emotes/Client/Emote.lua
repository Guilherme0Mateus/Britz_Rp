...
Citizen.CreateThread(function()
    TriggerEvent('chat:addSuggestion', '/em', 'Play an emote', {{ name="emotename", help="dance, camera, sit or any valid emote."}})
    TriggerEvent('chat:addSuggestion', '/em', 'Play an emote', {{ name="emotename", help="dance, camera, sit or any valid emote."}})
...
RegisterCommand('em', function(source, args, raw) EmoteCommandStart(source, args, raw) end)
