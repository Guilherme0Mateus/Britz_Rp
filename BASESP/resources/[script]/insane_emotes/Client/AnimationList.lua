...
DP.Emotes = {
   ...
   ["agrau"] = {"random@mugging4", "struggle_loop_b_thief", "grau", AnimationOptions =
   {
    EmoteLoop = true,
    EmoteMoving = true,
   }},
...
-----------------------------------------------------------------------------------------------------------
   ...
   ["agrau3"] = {"timetable@reunited@ig_10", "base_amanda", "agrau3", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["agrau2"] = {"missfbi1", "ledge_loop", "grau2", AnimationOptions =
   {
    EmoteLoop = true,
   }},
}
