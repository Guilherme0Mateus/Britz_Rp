...
RegisterCommand(cfg.cmddv,function(source,args,rawCommand)
	local user_id = vRP.getUserId(source)
	if vRP.hasPermission(user_id,cfg.perm1) or vRP.hasPermission(user_id,cfg.perm2) or vRP.hasPermission(user_id,cfg.perm3) or vRP.hasPermission(user_id,cfg.perm4) or vRP.hasPermission(user_id,cfg.perm5) or vRP.hasPermission(user_id,cfg.perm6) or vRP.hasPermission(user_id,cfg.perm7) or vRP.hasPermission(user_id,cfg.perm8) or vRP.hasPermission(user_id,cfg.perm9) or vRP.hasPermission(user_id,cfg.perm10) then
...
RegisterCommand(cfg.cmgcar,function(source,args,rawCommand)
	...
	if user_id then
		local identity = vRP.getUserIdentity(user_id)
		if vRP.hasPermission(user_id,cfg.comandodv1) or vRP.hasPermission(user_id,cfg.comandodv2) or vRP.hasPermission(user_id,cfg.comandodv3) or vRP.hasPermission(user_id,cfg.comandodv4) or vRP.hasPermission(user_id,cfg.comandodv5) then
			if args[1] then
